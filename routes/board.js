...
const { board, write, boardView, boardHeart, board_best } = require("../controllers/boardControl");
 ...
 * @summary Best
 */
router.post("/best", board_best, (req, res) => {
    res.json(myResponse(true, "best 성공", "data", { bestboard: req.board }));
});
